...
class CategoryModel extends amplify_core.Model {
  ...
  const CategoryModel._internal(
      {required this.id, category, image, parameterTypes, createdAt, updatedAt})
      : _category = category,
        _image = image,
  ...
  factory CategoryModel(
    ...
    return CategoryModel._internal(
        ...
        parameterTypes: parameterTypes != null
            ? List<String>.unmodifiable(parameterTypes)
            : parameterTypes);
  }
  ...
  String toString() {
    ...
    buffer.write("parameterTypes=" +
        (_parameterTypes != null ? _parameterTypes!.toString() : "null") +
        ", ");
  ...
  CategoryModel copyWith(
      {String? category, String? image, List<String>? parameterTypes}) {
    return CategoryModel._internal(
        id: id,
  ...
  static final PARAMETERTYPES =
      amplify_core.QueryField(fieldName: "parameterTypes");
...
class CategoryModelIdentifier
    implements amplify_core.ModelIdentifier<CategoryModel> {
  final String id;
