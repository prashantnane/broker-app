...
class CategoryModel extends amplify_core.Model {
  ...
  const CategoryModel._internal({required this.id, category, image, parameterTypes, createdAt, updatedAt}): _category = category, _image = image, _parameterTypes = parameterTypes, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CategoryModel({String? id, String? category, String? image, List<String>? parameterTypes}) {
    return CategoryModel._internal(
  ...
  CategoryModel copyWith({String? category, String? image, List<String>? parameterTypes}) {
    return CategoryModel._internal(
      id: id,
  ...
  CategoryModel copyWithModelFieldValues({
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: CategoryModel.IMAGE,
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
      key: CategoryModel.PARAMETERTYPES,
      isRequired: false,
      isArray: true,
...
class _CategoryModelType extends amplify_core.ModelType<CategoryModel> {
 ...
 */
class CategoryModelIdentifier implements amplify_core.ModelIdentifier<CategoryModel> {
  final String id;
