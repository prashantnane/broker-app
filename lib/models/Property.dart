...
class Property extends amplify_core.Model {
  ...
  PropertyModelIdentifier get modelIdentifier {
    return PropertyModelIdentifier(id: id);
  }
  ...
  const Property._internal(
      ...
      : _title = title,
        ...
        _assignedOutdoorFacility = assignedOutdoorFacility,
        _latitude = latitude,
        _longitude = longitude,
        _threeDImage = threeDImage,
        _video = video,
  ...
  factory Property(
      ...
      bool? isFavourite,
      bool? isInterested,
      List<String>? assignedOutdoorFacility,
      String? latitude,
      String? longitude,
      String? threeDImage,
      String? video}) {
    return Property._internal(
        ...
        assignedOutdoorFacility: assignedOutdoorFacility != null
            ? List<String>.unmodifiable(assignedOutdoorFacility)
            : assignedOutdoorFacility,
        latitude: latitude,
        longitude: longitude,
  ...
  bool operator ==(Object other) {
    ...
    return other is Property &&
        ...
        DeepCollectionEquality()
            .equals(_assignedOutdoorFacility, other._assignedOutdoorFacility) &&
  ...
  String toString() {
    ...
    buffer.write(
        "gallery=" + (_gallery != null ? _gallery!.toString() : "null") + ", ");
    buffer.write("state=" + "$_state" + ", ");
    buffer.write("city=" + "$_city" + ", ");
    buffer.write("country=" + "$_country" + ", ");
    buffer.write(
        "addedBy=" + (_addedBy != null ? _addedBy!.toString() : "null") + ", ");
    buffer.write("isFavourite=" +
        (_isFavourite != null ? _isFavourite!.toString() : "null") +
        ", ");
    buffer.write("isInterested=" +
        (_isInterested != null ? _isInterested!.toString() : "null") +
        ", ");
    buffer.write("assignedOutdoorFacility=" +
        (_assignedOutdoorFacility != null
            ? _assignedOutdoorFacility!.toString()
            : "null") +
        ", ");
  ...
  Property copyWithModelFieldValues(
    ...
    return Property._internal(
        ...
        customerEmail:
            customerEmail == null ? this.customerEmail : customerEmail.value,
        customerProfile: customerProfile == null
            ? this.customerProfile
            : customerProfile.value,
        customerNumber:
            customerNumber == null ? this.customerNumber : customerNumber.value,
        category: category == null ? this.category : category.value,
        description: description == null ? this.description : description.value,
        address: address == null ? this.address : address.value,
        clientAddress:
            clientAddress == null ? this.clientAddress : clientAddress.value,
        propertyType:
        ...
        isInterested:
            isInterested == null ? this.isInterested : isInterested.value,
        assignedOutdoorFacility: assignedOutdoorFacility == null
            ? this.assignedOutdoorFacility
            : assignedOutdoorFacility.value,
  ...
  Property.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _assignedOutdoorFacility =
            json['assignedOutdoorFacility']?.cast<String>(),
  ...
  static final amplify_core.QueryModelIdentifier<PropertyModelIdentifier>
      MODEL_IDENTIFIER =
      amplify_core.QueryModelIdentifier<PropertyModelIdentifier>();
  static final ID = amplify_core.QueryField(fieldName: "id");
  static final TITLE = amplify_core.QueryField(fieldName: "title");
  static final PRICE = amplify_core.QueryField(fieldName: "price");
  static final CUSTOMERNAME =
      amplify_core.QueryField(fieldName: "customerName");
  static final CUSTOMEREMAIL =
      amplify_core.QueryField(fieldName: "customerEmail");
  static final CUSTOMERPROFILE =
      amplify_core.QueryField(fieldName: "customerProfile");
  static final CUSTOMERNUMBER =
      amplify_core.QueryField(fieldName: "customerNumber");
  static final CATEGORY = amplify_core.QueryField(fieldName: "category");
  static final DESCRIPTION = amplify_core.QueryField(fieldName: "description");
  static final ADDRESS = amplify_core.QueryField(fieldName: "address");
  static final CLIENTADDRESS =
      amplify_core.QueryField(fieldName: "clientAddress");
  static final PROPERTYTYPE =
      amplify_core.QueryField(fieldName: "propertyType");
  ...
  static final ISINTERESTED =
      amplify_core.QueryField(fieldName: "isInterested");
  static final ASSIGNEDOUTDOORFACILITY =
      amplify_core.QueryField(fieldName: "assignedOutdoorFacility");
 ...
 */
class PropertyModelIdentifier
    implements amplify_core.ModelIdentifier<Property> {
  final String id;

  /** Create an instance of PropertyModelIdentifier using [id] the primary key. */
  const PropertyModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is PropertyModelIdentifier && id == other.id;
  }
