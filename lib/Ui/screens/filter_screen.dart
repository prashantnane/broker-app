    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(UiUtils.getTranslatedLabel(context, "lblall")).color(
            selectedCategory == null
                ? context.color.textAutoAdapt(context.color.teritoryColor)
        ...
        child: TextFormField(
            ...
            decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10),
                    borderSide: BorderSide(color: context.color.teritoryColor)),
                labelStyle: TextStyle(color: context.color.teritoryColor),
                hintText: "00",
                label: Text(
                  minMax,
                ),
            ...
            style:
                TextStyle(color: Theme.of(context).colorScheme.teritoryColor),
            /* onSubmitted: () */
            ...
            children: <Widget>[
              UiUtils.buildButton(
                ...
                buttonColor: searchbody[Api.postedSince] == Constant.filterAll
                    ? context.color.teritoryColor
                    : context.color.teritoryColor.withOpacity(0.05),
