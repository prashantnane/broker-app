...
class ViewAllScreen<T extends StateStreamable<C>, C> extends StatefulWidget {
  ...
  ViewAllScreen({
    ...
    assert(T is! PropertyErrorStateWireframeTest,
...
class _ViewAllScreenState<T extends StateStreamable<C>, C>
  ...
  void onPageEnd() {
    ...
    if (_pageScrollListener.isEndReached()) {
      if (isSubtype<T, PropertyCubitWireframeTest>()) {
...
class StateMap<INITIAL, PROGRESS, SUCCESS extends PropertySuccessStateWireframeTest,
FAIL extends PropertyErrorStateWireframeTest> {
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                      ...
                      child: PropertyHorizontalCardTest(property: model));
                },
