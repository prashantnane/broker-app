...
class PropertyDetailsTest extends StatefulWidget {
  ...
  @override
  PropertyDetailsTestState createState() => PropertyDetailsTestState();
                    ...
                    child: BlocListener<UpdatePropertyStatusCubit,
                      ...
                      listener: (context, state) {
                        ...
                        if (state is UpdatePropertyStatusSuccess) {
                          ...
                          // (cubitReference as FetchAllPropertiesCubit)
                          //     .updateStatus(
...
class CusomterProfileWidget extends StatelessWidget {
  ...
  final PropertyDetailsTest widget;
